        ...
        <div className="mx-5">
          <div className="d-inline-flex my-5">
            <Row>
                ...
                <Row>
                  ...
                  <Col lg={12}>
                    <p className="div-1-text">
                      ...
                      for security, so you can store your data here safely but
                      not be afraid of being stolen by others.
                    </p>
                  </Col>
                  <Col lg={12}>
                    <div className="div-1-btn d-lg-flex justify-content-lg-center m-auto">
              ...
              <Col xl={6} lg={12}>
                <div className="div-1-img d-flex justify-content-end">
                  <img
              ...
              <Row>
                <Col span={12} className="my-4">
                  <div className="float-end" style={{ position: "relative" }}>
                    ...
                    >
                      <h3 className="fw-normal mb-3 text-h3">Search Data</h3>
                      <p
                      ...
                      >
                        ...
                        Warehouse provides a search engine, which is useful for
                ...
                <Col span={12} className="my-4">
                  <div className="float-end" style={{ position: "relative" }}>
                    ...
                    >
                      <h3
                        className="fw-normal mb-3 text-h3"
                      ...
                      >
                        ...
                        meet again in the morning, giving you comfort when you
                        need data when urgent.
                      </p>
                      <Link to={"/"} className="custom-link">
                        Learn more
                        <ArrowRightOutlined className="ms-2 icon-link" />
                ...
                <Col span={12} className="my-4">
                  <div className="float-end" style={{ position: "relative" }}>
                    ...
                    >
                      <h3 className="fw-normal mb-3 text-h3">Print Out</h3>
                      <p
                        className="fst-italic"
                        style={{
                          fontSize: "16px",
                ...
                <Col span={12} className="my-4">
                  <div className="float-end" style={{ position: "relative" }}>
                    ...
                    >
                      <h3 className="fw-normal mb-3 text-h3">Security Code</h3>
                      <p
                        className="fst-italic"
                        style={{
                          fontSize: "16px",
                      ...
                      >
                        ...
                        code or password than you created, so only you can open
                        the file.
                      </p>
                      <Link to={"/"} className="custom-link">
                        Learn more
