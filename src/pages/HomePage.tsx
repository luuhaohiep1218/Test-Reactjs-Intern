...
const HomeNotSignIn = () => {
  ...
  const featuresRef = useSpringRef();
  const scaleRef1 = useSpringRef();
  const scaleRef2 = useSpringRef();

  const springsImg = useSpring({
    ref: img,
  });
  const springsFeatures = useSpring({
    ref: featuresRef,
    config: { tension: 200, friction: 20 },
  });
  const scale1Spring = useSpring({
    ref: scaleRef1,
    from: { scale: 0.8 },
    to: { scale: 1 },
    config: { tension: 200, friction: 20 },
  });
  const scale2Spring = useSpring({
    ref: scaleRef2,
    from: { scale: 0.8 },
    to: { scale: 1 },
    config: { tension: 200, friction: 20 },
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (scrollPosition > 250 && !showFeatures) {
        featuresRef.start({
          from: { opacity: 0, y: 0 },
          to: { opacity: 1, y: 100 },
          delay: 500,
      ...
      } else if (scrollPosition <= 230 && showFeatures) {
        setShowFeatures(false);
      }

      if (scrollPosition > 300 && !showFeaturesCard) {
        scaleRef1.start({ scale: 1, delay: 2000 });
        setShowFeaturesCard(true);
      } else if (scrollPosition <= 260 && showFeaturesCard) {
        scaleRef1.start({ scale: 0.8 });
        scaleRef2.start({ scale: 0.8 });

        setShowFeaturesCard(false);
      }

      if (scrollPosition > 650 && !showFeaturesCard) {
      ...
      <Container className="mb-4">
        ...
        <Container>
          <div className="mx-5">
            ...
            <div className="my-5 pt-2 pb-5">
              {showFeatures && (
                <animated.div className="m-5" style={springsFeatures}>
                  <h2 className="features text-center fs-1 my-5 fw-bolder">
                    Features
                  </h2>
                  <p
                          ...
                          <Col xl={6} lg={12}>
                            <div className="features-car-content m-auto">
                              ...
                              <p className="features-car-text fst-italic fw-lighter">
                                ...
                                and meet again in the morning, giving you
                          ...
                          <Col xl={6} lg={12}>
                            <div className="features-car-content m-auto">
                              ...
                              <p className="features-car-text fst-italic fw-lighter">
                                ...
                                someday you need print data, just edit it all
                                and just print it.
                              </p>
                              <Link to={"/"} className="custom-link">
                                Learn more
                          ...
                          <Col xl={6} lg={12}>
                            <div className="features-car-content m-auto">
                              ...
                              <p className="features-car-text fst-italic fw-lighter">
                                ...
                                be secured with a code or password than you
